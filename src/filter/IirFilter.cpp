...
namespace Capture
{
	IirFilter::IirFilter(double* coef_a, double* coef_b, int sz_a, int sz_b)
	{
		/*
	...
	IirFilter& IirFilter::operator=(const IirFilter& rhs)
	{
		if (this == &rhs)
			return *this;
		size_a = rhs.size_a;
	...
	double IirFilter::DoProcess(double input)
	{
